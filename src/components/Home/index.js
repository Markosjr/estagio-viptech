...
class Home extends Component {
    ...
    render(){
        return(
            <div>
                <h1 className='produtos'>
                    Produtos
                </h1>
                <div>
                    <button type="submit" className='addproduto'> <BsFillPlusCircleFill/> Adicionar Produto </button>
                </div>
                    <br></br>
                ...
                {/* <div>
                    ...
                    <form>
                        ...
                        <legend class="legend-border"></legend>Nome do Produto</fieldset>
                         <br></br>
                     

                       
                        <fieldset class="fieldset-border"><input type="text " placeholder='Digite a marca do Produto:' value={this.state.marca}
                         onChange={(e) => this.setState({marca: e.target.value})}></input> <br></br><legend class="legend-border"></legend>Marca</fieldset>
                         

                        <fieldset class="fieldset-border"><input type="number" placeholder='R$000.00' value={this.state.valor}
                         onChange={(e) => this.setState({valor: e.target.value})}></input> <br></br><legend class="legend-border"></legend>Valor</fieldset>
                         

                         <fieldset class="fieldset-border"><input type="option" placeholder='Selecione a Cor' value={this.state.cor}
                         onChange={(e) => this.setState({valor: e.target.value})}></input> <br></br><legend class="legend-border"></legend>Cor</fieldset>
                         

                         <fieldset class="fieldset-border"><input type="date"  value={this.state.data}

                         onChange={(e) => this.setState({valor: e.target.value})}></input> <br></br><legend class="legend-border"></legend>Dat</fieldset>
                         ...
                         <div> 
                             ...
                             <input type='file' name='fotos' id='fotos'></input>

                         </div> */}

                         {/* <div>
                             <button type='submit' className='addproduto1'> Adicionar Produto </button>
                         </div> */}
